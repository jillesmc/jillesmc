...
- `2026-09-21` **[compozy/compozy](https://github.com/compozy/compozy)** — [cy-create-tasks can write an unquoted title containing a colon, and the spec-cycle importer th…](https://github.com/compozy/compozy/issues/663) <sub>issue, open</sub>
