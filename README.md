...
- `2026-09-12` **[compozy/compozy](https://github.com/compozy/compozy)** — [A provider overlay gets no builtin and no live model catalog, so the operator has to guess the…](https://github.com/compozy/compozy/issues/627) <sub>issue, closed</sub>
...
- `2024-11-04` **[structurizr/onpremises](https://github.com/structurizr/onpremises)** — [Saml authentication stopped to work in version v2024-11-04](https://github.com/structurizr/onpremises/issues/138) <sub>issue, closed</sub>
- `2023-10-05` **[drodil/backstage-plugin-toolbox](https://github.com/drodil/backstage-plugin-toolbox)** — [backstage version bump is not possible - createCardExtension should be imported from @backstag…](https://github.com/drodil/backstage-plugin-toolbox/issues/55) <sub>issue, closed</sub>
<!-- oss ends -->
